...
@section('content')
    ...
    <div class="container youplay-content">
        <div class="col-md-12">
            <div id="cart-main">
                <h3>Этот платеж уже был ранее оплачен и получен</h3>
            </div>
        </div>
        <!-- Right Side -->
<!--        <div class="col-md-3">
            &lt;!&ndash; Side Search &ndash;&gt;
            ...
            &lt;!&ndash; Side Popular News &ndash;&gt;
            <div class="side-block">
                <h4 class="block-title">Popular Games</h4>
                <div class="block-content p-0">
                    &lt;!&ndash; Single News Block &ndash;&gt;
