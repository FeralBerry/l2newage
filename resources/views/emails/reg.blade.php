...
<body>
<table class="table-body" role="presentation" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <td class="td-body">
            <table class="container" role="presentation" cellpadding="0" cellspacing="0" style="width: 100%;">
                <tbody>
                <tr>
                    <td align="center" style="line-height: 24px; font-size: 16px; margin: 0; padding: 0 16px;">
                        ...
                        <tr>
                            <td width="600">
                        <![endif]-->
                        <table class="table-content" role="presentation" cellpadding="0" cellspacing="0">
                            <tbody>
                            <tr>
                                <td class="td-content">
                                    ...
                                    <div style="margin-left: 45%">
                                        <img class="w-16 logo" alt="logo" src="https://l2newage.ru/front/img/icon.png">
                                    </div>
                                    <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                        <tbody>
                                        <tr>
                                    ...
                                    <div class="space-y-4">
                                        <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">Спасибо за регистрацию, {{ $name }}</h1>
                                    ...
                                    <table class="card rounded-3xl px-4 py-8 p-lg-10" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-radius: 24px; border-collapse: separate !important; width: 100%; overflow: hidden; border: 1px solid #e2e8f0;" bgcolor="#ffffff">
                                        ...
                                        <tr>
                                            <td class="reg_data">
                                                <h3 class="text-center" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center">Ваши регистрационные данные</h3>
                                                <p class="text-center text-muted" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="center">Никому не сообщайте их</p>
                                                <div class="col-md-12" style="width: 100%">
                                                    <div class="row" style="width: 100%;">
                                                        <div style="display:inline-block;width:240px;line-height: 24px; font-size: 16px; margin: 0; padding: 8px; text-align: left" class="col-md-6">
                                                            Имя на сайте
                                                        </div>
                                                        <div style="text-align:right;display:inline-block;width:240px;line-height: 24px; font-size: 16px; margin: 0; padding: 8px; text-align: right" class="col-md-6">
                                                            {{ $name }}
                                                        </div>
                                                        <div style="display:inline-block;width:240px;line-height: 24px; font-size: 16px; margin: 0; padding: 8px; text-align: left" class="col-md-6">
                                                            E-mail\Логин для входа
                                                        </div>
                                                        <div style="text-align:right;display:inline-block;width:240px;line-height: 24px; font-size: 16px; margin: 0; padding: 8px; text-align: right" class="col-md-6">
                                                            {{ $email }}
                                                        </div>
                                                ...
                                                <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Если не вы делали регистрацию то просто проигнорируйте это письмо.</p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
