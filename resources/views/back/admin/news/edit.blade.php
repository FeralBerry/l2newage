...
@section('content')
    <div class="container youplay-content" style="margin-top: 100px">
        <div class="row">
            <a href="{{ route('admin-news-add-index') }}" class="btn btn-success">Добавить</a>
            <table class="youplay-messages table table-hover">
                <thead>
                <tr>
                    <td style="width: 15%">Название</td>
                    <td>Краткое описание</td>
                    <td style="width: 20%">Изображения и теги</td>
                    <td style="width: 18%">Действия</td>
                </tr>
                </thead>
                <tbody>
                    @foreach($news as $item)
                        <tr class="message-unread">
                            ...
                            <td>
                                <div class="youplay-news youplay-post" style="margin-top: -35px">
                                    <!-- Post Info -->
                            ...
                            <td>
                                <a href="{{ route('admin-news-edit-index',$item->id) }}" class="btn btn-success">Редактировать</a>
